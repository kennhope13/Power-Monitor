...
public class BoundariesController : ControllerBase
{
    ...
    public async Task<IActionResult> Create(Guid deviceId, [FromBody] BoundaryRequest req)
    {
        ...
        if (boundaryType == "roi")
        {
            var maxRoiRegions = (licenseStatus != null && licenseStatus.IsValid) ? licenseStatus.MaxRoiRegions : 5;
        ...
        {
            var maxPdRegions = (licenseStatus != null && licenseStatus.IsValid) ? licenseStatus.MaxPdRegions : 5;
